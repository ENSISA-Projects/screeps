/******************************************************************************
 *  creep.brain.js — minimalist helpers for per-creep Q-learning
 *  ----------------------------------------------------------
 *  Exports two functions:
 *     • act()   – ε-greedy action choice given a `brain` object
 *     • learn() – one-step Q-update for that same brain
 *
 *  The brain object (kept in creep.memory.brain) is expected to hold:
 *       {
